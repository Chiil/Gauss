...
pl.matplotlib.rcParams['pcolor.shading'] ='nearest'
class plot_gauss_fix:
...
#       yz cross-section at x
        ...
        print("Concentration at [x,y,z] = [%.im,%.im,%.im] = %.f ug/m3"  \
              %(self.xpos.value,self.ypos.value,self.zpos.value,self.conc.value))
